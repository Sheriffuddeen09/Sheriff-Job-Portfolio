        ...
        <div>
            {
                applys.map((apply) =>{
                   ...
                   <div className="flex flex-row flex-wrap justify-around p-2 mt-10">
                    ...
                    <div className={`bg-black opacity-90 w-screen right-0 z-10 h-full fixed top-0 ${flex ? "block" : "hidden"}`}>
...
Reports
                    ...
                    <div className={`fixed top-0 right-0 z-10 bg-black opacity-90 w-full h-full ${deleted ? "block" : "hidden"}`}>
...
<span className="inline-flex gap-4 items-center">
    <input type="checkbox" value={check} onChange={handleChange} className="h-10 w-5 p-4" />
    <label>Indeed helped me get a job</label>
</span>
<span className="inline-flex gap-4 items-center">
    <input type="checkbox" className="h-10 w-5 p-4"  />
