...
const ArchiveAccordion = ({accordion}) =>{
...
return(
    <div className="" >
          <button onClick={toggleSubmit} className={`selectinput flex-row justify-between flex gap-12 items-center sm:w-66 w-64 outline-blue-800 border mb-4 border-black rounded-lg px-5 font-bold py-2 ${isVisible ? "noneselect" : "selectinput"}`}>
        Archive
