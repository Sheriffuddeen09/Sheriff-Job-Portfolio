...
const handleSidebar = () =>{
 ...
 Easily apply</p>
        ...
        <p className="">visited 1 day ago</p>
          ...
          <div onClick={handleMenuIcon} className={`z-10 bg-white border-gray-200 border p-4 rounded-lg w-44 leading-10 relative sm:bottom-60 bottom-80 left-28 -translate-y-32 sm:-translate-y-20 md:left-60 lg:left-96 -mb-48  ${menuicon ? "block" : "hidden"}`}>
