...
const handleSidebar = () =>{
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5ZM12 12.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5ZM12 18.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5Z" />
        ...
        <p className='bg-green-200 w-44 p-1 text-green-800 font-bold rounded'>{job.amount} 💚</p>
        <p className='bg-green-200 w-30 p-1 text-green-800 rounded font-bold'>{job.type} 💚 +</p>
 ...
 Easily apply</p>
        ...
        <p className="">visited 1 day ago</p>
          ...
          <div onClick={handleMenuIcon} className={`z-10 bg-white border-gray-200 border p-4 rounded-lg w-44 leading-10 relative sm:bottom-80 bottom-80 left-28 -translate-y-32 sm:-translate-y-20 md:left-60 lg:left-96 -mb-48  ${menuicon ? "block" : "hidden"}`}>
