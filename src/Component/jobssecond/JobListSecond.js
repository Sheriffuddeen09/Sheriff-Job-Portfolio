...
const handleSidebar = () =>{
 ...
 Easily apply</p>
        ...
        <p className="">visited 1 day ago</p>
          ...
          <div className={` bg-white border-gray-200 border p-4 rounded-lg w-44 leading-10 relative bottom-80 left-40 sm:bottom-64 sm:left-96 -mb-60  ${menuicon ? "block" : "hidden"}`}>
