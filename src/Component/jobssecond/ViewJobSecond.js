...
const ViewJobSecond = ({jobseconds}) =>{
    ...
    return (
        ...
        <p className="inline-flex gap-2 mb-2 items-center">{job.company}<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4">
       ...
       <Link to={'/login'}> <button className="bg-blue-700 hidden sm:block text-white p-2 w-28 rounded-lg">
        Apply
    </button>
    </Link>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636" />
    ...
    <div className="flex -translate-y-16 mt-0 h-96 border-2 p-3 rounded-lg md:w-full gap-0 mx-auto scrollb scroll-p-0 scroll-smooth scrollbar scrollbar-thumb-blue-300 
    md:h-96
     scrollbar-thin 
    scrollbar-track-white lg:h-48 lg:flex flex-col lg:h-0 mt-20 lg:mx-auto">
      <div>
...
<div>
<button className="bg-gray-300 my-4 w-36 justify-center p-3 gap-3 inline-flex text-black sm:p-3 sm:w-36 sm:gap-3 rounded-lg sm:-mt-6 sm:inline-flex">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
