...
const About = () =>{
        ...
        <div>
            {
                ...
                pdfs.map((pdf) =>(
                <>
                    <div className="flex flex-row justify-between border border-black py-1 rounded-lg gap-24 lg:gap-48 flex-wrap mt-6 items-center">
                ...
                <span>
                    ...
                    onClick={handlePdf}
                    stroke-width="1.5" stroke="currentColor" class="size-6 mr-10 cursor-pointer">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5ZM12 12.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5ZM12 18.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5Z" />
                    </svg>

                    </div>
                     <div className={` border border-black p-4 rounded-lg w-40 relative bottom-10 left-72 lg:left-96 bg-white ${pdficon ? "block" : "hidden"}`}>
                     <span>
    ...
    const content = (
        <div>
            {
                infos.map((info) =>(
              <Link to={'/profile'}>  <div className="flex flex-row justify-between lg:gap-96 gap-64 mt-6 items-center">
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center mt-8">
            <div className="inline-flex gap-4 items-center justify-center wrap">
                ...
                <h1 className="text-4xl font-bold ">ODUKOYA SHERIFF OLAWALE </h1>
                </span>
                <div className="text-4xl font-bold bg-gray-600 w-14 text-center flex items-center justify-center rounded-full h-14">FO</div>
            </div>
            <div>{content}</div>

            <h1 className="font-bold mr-96 text-xl mt-6 lg:-translate-x-10">Resume</h1>
            <div>
               {pdfContent}
            </div>
            <h1 className="font-bold mr-48 lg:mr-72 text-xl mt-6">Improve your job matches</h1>
            <hr className="w-11/12 lg:w-5/12  my-6"/>
           <Link to={'/qualify'}>
            <div className="flex flex-row items-center justify-center">
            <span>
            <h2 className="font-bold mr-64 lg:mr-96 text-xl ">Qualifications</h2>
        ...
        <Link to={'/jobtitle'}>
            <div className="flex flex-row items-center justify-center">
            <span>
            <h2 className="font-bold mr-20 lg:mr-72 gap-4 -translate-x-10 text-xl ">Job preferences</h2>
            <p className="text-sm -translate-x-10 w-80">Save specific details like minimum desired pay and schedule.</p>
            </span>
        ...
        <Link to={'/hide'}>
            <div className="flex flex-row items-center justify-center">
            <span>
            <h2 className="font-bold mr-20 lg:mr-64 text-xl ">Hide jobs with these details</h2>
            <p className="text-sm w-96">Manage the qualifications or preferences used to hide jobs from your search.</p>
            </span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
            </svg>
        ...
        <Link to={'/ready'}>
            <div className="flex flex-row items-center justify-center">
            <span>
            <h2 className="font-bold mr-20 lg:mr-96 text-xl ">Ready to work</h2>
            <p className="text-sm w-96">Let employers knows that you're available to start working as soon as possible</p>
            </span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
            </svg>
