...
const NewCertificate = ({newcertificates}) =>{
            ...
            <div>
              {
                newcertificates.map((newcertificate) =>{
                    return(
                        ...
                        <span>
                        <p className="font-bold mb-2">{newcertificate.title}</p>
                        <p className="mb-2">{newcertificate.name}</p>
                        </span>
                        <Link to={`/ceradd/${newcertificate.id}`}>   
