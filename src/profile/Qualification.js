...
const Qualifications = ({posts, educations, skills, newskill, neweducations,newlicences, languages,licences, certifications}) =>{
            ...
            <div>
                {
                    posts.map((post) =>{
                        ...
                        return (
                            <div className="flex flex-row justify-center gap-2 sm:gap-28 lg:justify-between flex-wrap ">
                                ...
                                <span>
                                    <p className="font-bold sm:text-xl mb-1">{post.title}</p>
    ...
    return(
        <div className="flex flex-col px-2 items-center  my-6"> 
        <div>
